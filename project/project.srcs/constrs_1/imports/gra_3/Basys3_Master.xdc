...
#Constraints for ps2_clk and ps2_data
...
##Buttons
#set_property PACKAGE_PIN T18 [get_ports transfer_sw]						
#	set_property IOSTANDARD LVCMOS33 [get_ports transfer_sw]
#set_property PACKAGE_PIN W19 [get_ports back_sw]						
#	set_property IOSTANDARD LVCMOS33 [get_ports back_sw]
#set_property PACKAGE_PIN T17 [get_ports putt_sw]						
#        set_property IOSTANDARD LVCMOS33 [get_ports putt_sw]
#set_property PACKAGE_PIN U17 [get_ports start_left]						
#           set_property IOSTANDARD LVCMOS33 [get_ports start_left]
